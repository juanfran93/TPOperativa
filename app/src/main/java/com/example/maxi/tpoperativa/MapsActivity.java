...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        addPointIntoMap(this.user.getLatitude(), this.user.getLongitude(), this.user.getDireccion());

    }

    private void addPointIntoMap(double latitude, double longitude,String text){
